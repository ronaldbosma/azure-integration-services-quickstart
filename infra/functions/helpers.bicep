...
@export()
func getEventHubEndpointAddress(eventHubsNamespaceName string, eventHubName string) string =>
  '${getServiceBusFullyQualifiedNamespace(eventHubsNamespaceName)}/${eventHubName}'
...
@export()
func getServiceBusEndpoint(serviceBusNamespaceName string) string =>
  'https://${getServiceBusFullyQualifiedNamespace(serviceBusNamespaceName)}'

@export()
func getServiceBusFullyQualifiedNamespace(serviceBusNamespaceName string) string =>
